---
title: 'PostgreSQL 15 报错 [42501]: ERROR: permission denied for schema public'
date: '2023-11-11'
lastmod: '2023-11-11'
tags: ['PostgreSQL', 'PostgreSQL15', '42501', 'permission denied']
draft: false
...
```
<Image src="/static/images/tech/postgres-login.png"  width={800} height={450} alt="postgres登录"/>
...
```
<Image src="/static/images/tech/test_user-login.png"  width={800} height={450} alt="test_user登录"/>
...
```
<Image src="/static/images/tech/postgres-login-testdb.png"  width={800} height={450} alt="test_user登录"/>
...
```
<Image src="/static/images/tech/create-table-success.png"  width={800} height={450} alt="test_user登录"/>
